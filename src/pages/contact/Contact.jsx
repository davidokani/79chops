      ...
      <div class="content-input">
        ...
        <div class="container">
          ...
          <form action="">
            ...
            <input type="text" placeholder="Enter Name" class="contact__input" required /><br />

            <label for="email">Email</label><br />

            <input type="mail" placeholder="Enter Email" class="contact__input" required /><br />

            <label for="message">Messeage</label><br />

            <textarea name="" id="" cols="25" rows="10" class="contact__input" required></textarea>
